...
function BuildingTableRow({ row, keys }:{row:Record<string,string>,keys:string[]}) {
  ...
  return (
    <Link href={`/${path.split("/")[2]}/buildings/${generateRandomNumber()}/overview`} className="cursor-pointer bg-white flex flex-row items-center py-3 border-b border-gray-100 hover:bg-gray-100">
