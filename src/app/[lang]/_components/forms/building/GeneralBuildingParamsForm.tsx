...
function GeneralBuildingParamsForm() {
  ...
  return (
    <>
      ...
      <TextInput
        title="Date de rénovation"
        type="date"
        registerKey={"building.renovationYear"}
        validations={{
          required: "Ce champ est obligatoir",
          valueAsNumber: true,
        }}
      />
      <TextInput
        title="Date de acquisition"
        type="date"
        registerKey={"building.acquisitionYear"}
        validations={{
          required: "Ce champ est obligatoir",
          valueAsNumber: true,
      ...
      />
      <TextInput
        title="Réglementation Thermique (RT) Applicable"
        type="text"
        registerKey={"building.applicableRT"}
        validations={{
          required: "Ce champ est obligatoir",
          valueAsNumber: true,
          validate: isValidYear,
      ...
      <DropDownRadioButtons
        options={[
          ...
          {
            label: "Complexe résidentiel et commercial",
            value: "residential_commercial_complex",
          },
      ...
      <DropDownRadioButtons
        title="Régime de détention"
        registerKey="building.ownershipType"
        options={[
          { label: "Pleine propriété", value: "freehold" },
          { label: "Bail", value: "leasehold" },
          { label: "Condominium", value: "condominium" },
          { label: "Location", value: "rent" },
          { label: "Usufruit", value: "usufruct" },
          { label: "Droit au bail", value: "lease_right" },
          { label: "Copropriété", value: "co_ownership" },
          { label: "Propriété partagée", value: "shared_ownership" },
          { label: "Emphytéose", value: "emphyteusis" },
        ]}
        validations={{ required: "Ce champ est obligatoire" }}
      />
    </>
...
export default GeneralBuildingParamsForm;
