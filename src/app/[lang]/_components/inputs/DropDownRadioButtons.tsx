  ...
  return (
    <div className="flex flex-col space-y-1 mb-3 ">
      ...
      <div ref={typesMenuRef} className="relative">
        ...
        >
          {options
            ? options.find((option) => option.value === getValues(registerKey))
                ?.label
            : ""}
        </div>
        <div
          ...
          } absolute z-20 bg-white top-19 rounded-b-md overflow-hidden border border-gray-200 w-full max-h-52 overflow-y-auto`}
        >
          {options &&
            options.map((radio) => (
              <div
...
export default DropDownRadioButtons;
