        ...
        <div className="w-2/3 ">
          ...
          <div className="flex flex-row justify-between items-center space-x-1 mt-3">
            ...
            <div className="flex flex-col justify-center items-center bg-white rounded-md shadow-sm w-1/3 h-28">
              ...
              <span className="text-gray-600 font-opensans  text-4xl">12</span>
              <span className="text-base text-gray-500 font-thin ">Alarms</span>
            </div>
            <div className="flex flex-col justify-center items-center bg-white rounded-md shadow-sm w-1/3 h-28">
              <MdDeviceHub className="w-6 h-6 text-gray-600" />
              <span className="text-gray-600 font-opensans  text-4xl">22</span>
              <span className="text-base text-gray-500 font-thin ">Assets</span>
            </div>
          </div>
        </div>
